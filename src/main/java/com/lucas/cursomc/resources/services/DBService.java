...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat7 = new Categoria("TESTE");
		...
		Cliente cli1 = new Cliente("Lucas", "lfbassoli@gmail.com", "36378912377", EnumTipoCliente.PESSOA_FISICA, pe.encode("123456"));
		...
		ItemPedido ip2 = new ItemPedido(ped1, p3, 20.00, 2, 80.00);
